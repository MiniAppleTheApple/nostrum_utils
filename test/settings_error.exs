defmodule Elppa.Test.SettingsError do
  ...
  test "String length passed limit", attribute do
    limit = 1
    result = """
  ...
  test "Attribute not found", attribute do
    result = """
  ...
  test "Not a string", attribute do
    result = """
  ...
  test "Not a boolean", attribute do
    result = """
